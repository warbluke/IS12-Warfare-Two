/mob/living/simple_animal
	...
	var/bloody = TRUE //whether or not this thing drops blood when you harvest from it.
	var/butchered = FALSE
...
/mob/living/simple_animal/hit_with_weapon(obj/item/O, mob/living/user, var/effective_force, var/hit_zone)
	...
	if(attacked_sound)
		playsound(src, attacked_sound, 50)
	if(pain_sound.len)
		var/hurt_sound = pick(pain_sound)
		playsound(src, hurt_sound, 100, FALSE)
	receive_damage()
...
/mob/living/simple_animal/proc/harvest(var/mob/user)
	if(butchered)
		to_chat(user, "<span='bnotice'This creature has already been butchered.</span>")
