...
/mob/proc/u_equip(obj/W as obj)
	...
	else if(W == chest_holster)
		chest_holster = null
		update_inv_chest_holster(0)
	return
...
/mob/proc/get_equipped_item(var/slot)
	switch(slot)
		...
		if(slot_chest)	return chest_holster
	return null
...
/mob/proc/delete_from_slot(var/slot)
	var/obj/O = get_equipped_item(slot)
	if(O)
